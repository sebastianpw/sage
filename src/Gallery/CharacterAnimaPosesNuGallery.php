<?php
// src/Gallery/CharacterAnimaPosesNuGallery.php
namespace App\Gallery;
class CharacterAnimaPosesNuGallery extends AbstractNuGallery {
    ...
    protected function getBaseQuery(): string {
        return "v_gallery_character_anima_poses";
    }
    protected function getCaptionFields(): array {
        return [
            'Frame ID'          => 'frame_id',
            'Character Anima Pose ID' => 'character_anima_pose_id',
            'File Name'         => 'filename',
    ...
    protected function getGalleryEntity(): string {
        return "character_anima_poses";
    }
    protected function getGalleryTitle(): string {
        return "Character Anima Poses Gallery";
    }
