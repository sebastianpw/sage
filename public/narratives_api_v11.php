...
// Update V11: Switched to narratives_query_helpers_v11.php; passes V11 engine toggles
//             (enable_kg_graph, enable_sql_tags, enable_chroma) from filter_payload
//             through to buildRichQuery().
// ----------------------------------------------------
...
// enrichFilterQuery, buildRichQuery) — V11 version adds optional KG
// graph-walker support via enable_kg_graph flag in filter payload.
require_once __DIR__ . '/narratives_query_helpers_v11.php';
    ...
    try {
        switch ($_GET['action']) {
            ...
            case 'fetch_library':
                ...
                if ($filterData) {
                    // V11: enable_kg_graph, enable_sql_tags, enable_chroma are already
                    // part of $filterData when sent from the UI; buildRichQuery()
                    // (narratives_query_helpers_v11.php) reads enable_kg_graph from there.
