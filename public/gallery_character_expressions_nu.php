<?php
// public/gallery_character_expressions_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\CharacterExpressionsNuGallery;
...
// Configure gear menu module for character_expressions
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['character_expressions'],
]);
...
$gallery = new CharacterExpressionsNuGallery();
...
$spw->renderLayout(
    $content,
    "CharacterExpressions Gallery (Modular)",
