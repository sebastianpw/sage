<?php
// Template Placeholder: audio_dialogue_lines
...
<div style="padding-left:60px;" id="fixedHeader" class="fixed-header-wrapper">
    <div class="header-compact">
        ...
        <div class="header-controls">
            ...
            <a class="runBtn scheduler" data-id="35" title="Trigger Audio/Models Scheduler" style="cursor:pointer; font-size:1.2rem; text-decoration:none; margin-left:5px;">🌀</a>
