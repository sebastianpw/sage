<?php
// public/animatics_gallery.php
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\AnimaticsGallery;
...
$imageEditor = $registry->create('image_editor', [
    ...
    'enable_rotate' => true,
    'enable_resize' => true,
    'preset_filters' => ['grayscale', 'vintage', 'sepia', 'clarendon', 'gingham', 'moon', 'lark', 'reyes', 'juno', 'slumber'],
]);

// Create the gallery instance
$gallery = new AnimaticsGallery();
...
$spw->renderLayout($content,
    "Animatics Frames Gallery",
