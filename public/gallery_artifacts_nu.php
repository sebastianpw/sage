...
// Configure gear menu module for artifacts
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['artifacts'],
]);

// First action: View Frame
$gearMenu->addAction('artifacts', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new ArtifactsNuGallery();
