...
// Configure gear menu module for pastebin
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['pastebin'],
]);

// First action: View Frame
$gearMenu->addAction('pastebin', [
    'label' => 'View Frame',
    'icon' => '👁️',
