<?php
// public/gallery_scene_parts_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\ScenePartsNuGallery;
...
// Configure gear menu module for scene_parts
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['scene_parts'],
]);

// First action: View Frame
$gearMenu->addAction('scene_parts', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new ScenePartsNuGallery();
