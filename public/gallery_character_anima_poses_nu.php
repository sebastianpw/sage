<?php
// public/gallery_character_anima_poses_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\CharacterAnimaPosesNuGallery;
...
// Configure gear menu module for character_anima_poses
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['character_anima_poses'],
]);
...
$gallery = new CharacterAnimaPosesNuGallery();
...
$spw->renderLayout(
    $content,
    "CharacterAnimaPoses Gallery (Modular)",
