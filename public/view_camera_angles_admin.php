<?php
// public/view_camera_angles_admin.php
require_once __DIR__ . '/bootstrap.php';
$spw = \App\Core\SpwBase::getInstance();
$pdo = $spw->getPDO();
$pageTitle = "Camera Angles Admin";
ob_start();
...
<div class="admin-wrap">
    <div class="admin-head">
        <h2>Manage Camera Angles</h2>
        <div>
            <a class="btn btn-sm btn-outline-secondary" href="view_sketch_templates_admin.php">&larr; Back to Templates</a>
            <button class="btn btn-sm btn-primary" onclick="openCreateModal()">+ New Angle</button>
        </div>
    </div>
...
<div id="formModal" class="modal-overlay">
    <div class="modal-card">
        <div class="modal-header">
            <h3 id="modalTitle">Create Angle</h3>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-sm btn-primary" onclick="saveItem()">Save Angle</button>
        </div>
    </div>
</div>
...
<script>
const API_URL = '/camera_angles_api.php';
const ENTITY_NAME = 'Angle';
