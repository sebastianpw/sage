...
// Configure gear menu module for sketches
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['sketches'],
]);

// First action: View Frame
$gearMenu->addAction('sketches', [
    'label' => 'View Frame',
    'icon' => '👁️',
