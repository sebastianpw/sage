<?php
// public/view_camera_perspectives_admin.php
require_once __DIR__ . '/bootstrap.php';
$spw = \App\Core\SpwBase::getInstance();
$pdo = $spw->getPDO();
$pageTitle = "Camera Perspectives Admin";
ob_start();
...
<div class="admin-wrap">
    <div class="admin-head">
        <h2>Manage Camera Perspectives</h2>
        <div>
            <a class="btn btn-sm btn-outline-secondary" href="view_sketch_templates_admin.php">&larr; Back to Templates</a>
            <button class="btn btn-sm btn-primary" onclick="openCreateModal()">+ New Perspective</button>
        </div>
    </div>
...
<script>
const API_URL = '/camera_perspectives_api.php';
const ENTITY_NAME = 'Perspective';
