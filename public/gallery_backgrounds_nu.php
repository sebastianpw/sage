<?php
// public/gallery_backgrounds_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\BackgroundsNuGallery;
...
// Configure gear menu module for backgrounds
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['backgrounds'],
]);

// First action: View Frame
$gearMenu->addAction('backgrounds', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new BackgroundsNuGallery();
