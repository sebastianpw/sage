<?php
// public/gallery_character_poses_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\CharacterPosesNuGallery;
...
// Configure gear menu module for character_poses
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['character_poses'],
]);

// First action: View Frame
$gearMenu->addAction('character_poses', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new CharacterPosesNuGallery();
...
$spw->renderLayout(
    $content,
    "CharacterPoses Gallery (Modular)",
