<?php
// public/gallery_prompt_matrix_blueprints_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\PromptMatrixBlueprintsNuGallery;
...
$entity = 'prompt_matrix_blueprints';

// Configure gear menu module for prompt_matrix_blueprints
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['prompt_matrix_blueprints'],
]);

// First action: View Frame
$gearMenu->addAction('prompt_matrix_blueprints', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new PromptMatrixBlueprintsNuGallery();
...
$spw->renderLayout(
    $content,
    "PromptMatrixBlueprints Gallery (Modular)",
