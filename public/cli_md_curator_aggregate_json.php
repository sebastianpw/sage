<?php
// public/cli_md_curator_aggregate_json.php
// PART 2: AGGREGATOR (Assembler) - ENHANCED LORE EXTRACTION
// JSON-capable, surgical update:
// - Preserves the original processing logic
// - Adds JSON config support for targetCategoryId / limit
...
if (isset($opts['config'])) {
    $jsonMode = true;
    $cfgRaw = file_get_contents($opts['config']);
