<?php
// public/gallery_characters_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\CharactersNuGallery;
...
// Configure gear menu module for characters
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['characters'],
]);

// First action: View Frame
$gearMenu->addAction('characters', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new CharactersNuGallery();
