<?php
// public/gallery_meta_entities_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\MetaEntitiesNuGallery;
...
// Configure gear menu module for meta_entities
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['meta_entities'],
]);

// First action: View Frame
$gearMenu->addAction('meta_entities', [
    'label' => 'View Frame',
    'icon' => '👁️',
...
$gallery = new MetaEntitiesNuGallery();
