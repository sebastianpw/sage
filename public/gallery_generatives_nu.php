<?php
// public/gallery_generatives_nu.php
// Auto-generated modular gallery view
require_once __DIR__ . '/bootstrap.php';
require __DIR__ . '/env_locals.php';

use App\Core\SpwBase;
use App\Gallery\GenerativesNuGallery;
...
// Configure gear menu module for generatives
$gearMenu = $registry->create('gear_menu', [
    'position' => 'top-right',
    'icon' => '&#9881;',
    'icon_size' => '2em',
    'show_for_entities' => ['generatives'],
]);
...
$gallery = new GenerativesNuGallery();
